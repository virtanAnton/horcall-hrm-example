...
public class OldDeviceActivity extends AppCompatActivity {
    ...
    public static Intent getCallingIntent(Context context, PolarHrmModel hrm) {
        Intent intent = new Intent(context, OldDeviceActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLogCopy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ActivityCompat.checkSelfPermission(OldDeviceActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        != PackageManager.PERMISSION_GRANTED) {
                    // Check Permissions Now
                    ActivityCompat.requestPermissions(OldDeviceActivity.this,
    ...
    private void connectBtnAction() {
        ...
        if (mBluetoothAdapter == null || !mBluetoothAdapter.isEnabled()) {
            Toast.makeText(OldDeviceActivity.this, "Turn on bluetooth!", Toast.LENGTH_SHORT).show();
